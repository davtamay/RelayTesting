...
//var socket = io.connect('https://localhost:3000/chat', { secure: true, reconnect: true, rejectUnauthorized : false } );
var socket = io.connect('https://appsocket.net:3000/chat', { secure: true, reconnect: true, rejectUnauthorized : false } );
